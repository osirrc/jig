...
if __name__ == "__main__":
    ...
    parser_prepare.add_argument("--save_to_tag", default="save", type=str, help="used to uniquely identify (part of hash) the snapshotted image after indexing")
    ...
    parser_search.add_argument("--load_from_tag", default="save", type=str, help="used to determine the snapshotted image to search from")
    ...
    parser_interact.add_argument("--load_from_tag", default="save", type=str, help="used to determine the snapshotted image to interact with")
